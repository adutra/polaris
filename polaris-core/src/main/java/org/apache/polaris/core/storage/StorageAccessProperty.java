...
public enum StorageAccessProperty {
  ...
  // Remote signing properties (Storage provider-agnostic)
  SIGNER_URI(
      String.class,
  ...
  SIGNER_PROPERTY_TOKEN(
      ...
      false),
  SIGNER_PROPERTY_STORAGE_TYPE(
      String.class,
      RemoteSigningProperty.STORAGE_TYPE.longName(),
      "the remote storage type, used for signing requests",
      false),
  SIGNER_PROPERTY_STORAGE_ENDPOINT(
      String.class,
      RemoteSigningProperty.STORAGE_ENDPOINT.longName(),
      "the remote storage endpoint, used for signing requests (optional)",
      false),
  ;
