  ...
  public StorageAccessConfig getRemoteSigningAccessConfig(
    ...
    StorageAccessConfig.Builder accessConfig =
        StorageAccessConfig.builder()
            ...
            .put(
                StorageAccessProperty.SIGNER_PROPERTY_STORAGE_TYPE,
                PolarisStorageConfigurationInfo.StorageType.S3.name())
    ...
    if (endpointUri != null) {
      accessConfig.put(
          StorageAccessProperty.SIGNER_PROPERTY_STORAGE_ENDPOINT, endpointUri.toString());
    }
