...
public class TestUtil {
   ...
   */
  public static RESTCatalog createSnowmanManagedCatalog(
      PolarisIntegrationTestHelper helper,
      String baseUrl,
      String realm,
      Catalog catalog,
    ...
    try (Response response =
        helper
            ...
            .header("Authorization", "Bearer " + helper.adminToken)
          ...
          helper
              ...
              .target(
                  String.format(
                      ...
                      baseUrl,
                      helper.snowmanCredentials.identifier().principalRoleName(),
                      currentCatalogName))
              .request("application/json")
              .header("Authorization", "Bearer " + helper.adminToken)
              .header(REALM_PROPERTY_KEY, realm)
    ...
    ImmutableMap.Builder<String, String> propertiesBuilder =
        ImmutableMap.<String, String>builder()
            ...
            .put(
                ...
                helper.snowmanCredentials.clientId()
                    + ":"
                    + helper.snowmanCredentials.clientSecret())
