...
public class PolarisIntegrationTestFixture {
  ...
  public final int localManagementPort;

  public PolarisIntegrationTestFixture(PolarisIntegrationTestHelper helper, TestInfo testInfo) {
    this.helper = helper;
    this.client = helper.client;
    this.localPort = helper.localPort;
    this.localManagementPort = helper.localManagementPort;
