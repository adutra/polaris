...
public class TestMetricsUtil {
  ...
  public static Map<String, MetricFamily> fetchMetrics(Client client, int localManagementPort) {
    Response response =
        client
            .target(String.format("http://localhost:%d/q/metrics", localManagementPort))
            .request()
            .get();
