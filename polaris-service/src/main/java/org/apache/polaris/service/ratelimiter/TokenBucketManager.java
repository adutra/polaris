...
public class TokenBucketManager {
  ...
  @Inject
  public TokenBucketManager(RateLimiterConfiguration configuration, Clock clock) {
    this(configuration.requestsPerSecond(), configuration.window(), clock);
  }

  public TokenBucketManager(long requestsPerSecond, Duration window, Clock clock) {
